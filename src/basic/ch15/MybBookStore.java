...
public class MybBookStore {
	...
	public static void main(String[] args) {
		...
		while (flag) {
			...
			System.out.println("1.저장 2.전체조회 3.선택조회 4.전체 삭제 0.프로그램 종료");
			// 문자열 + 다음줄로 이동 처리
			...
			if (selectedNumber.equals(SAVE)) {
				...
				save(sc, books, LAST_INDEX_NUMBER);
	...
	// 저장하기(하나의 북 객체를 저장)
	public static void save(Scanner sc, Book[] books, int lastIndexNumber) {
		System.out.println("----- 저장 하기 -----");
