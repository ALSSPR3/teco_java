...
public class MyArrayListTest {
	...
	public static void main(String[] args) {
		...
		ArrayList<Studnet> members = new ArrayList<Studnet>();

		// 클래스에 정의된 기능을 알아 봐야 한다.
		list.add(3);
		list.add(null);
		list.add(1, 10); // indext 1 위치에 요소 10을 삽입, 기존 요소가 있엇다면 뒤로 자동 이동
		System.out.println("값 추가 확인 : " + list);
		Studnet studnet = new Studnet("홍박사");
